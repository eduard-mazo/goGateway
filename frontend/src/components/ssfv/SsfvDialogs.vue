...
// SsfvDialogs — all SSFV modal dialogs (approve/bulk-approve + CRUD for
// planta/equipo/frontera/senal/senalXTipo/tipo-equipo/tipo-variable/unidad).
// Consumes the useSsfv() singleton; dialog open-state lives there, so any tab
// can trigger a dialog and this component renders it.
